...
interface EpubResourceResolver {
    /**
     * Ouvre l'EPUB à [fileUri] (identifié par [publicationId]) pour
     * résoudre les ressources. Doit être appelé avant [openStream].
     */
    suspend fun open(publicationId: String, fileUri: String)
