# 🤝 Guide de Contribution — ReadFlow

Merci de votre intérêt pour contribuer à ReadFlow ! 🎉
...
En attendant :
- ⭐ Star le repo
- 🐛 Signaler des bugs dans les [Issues](https://github.com/<user>/ReadFlow/issues)
- 💡 Proposer des idées dans les [Discussions](https://github.com/<user>/ReadFlow/discussions)
