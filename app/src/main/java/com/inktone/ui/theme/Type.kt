...
val InkToneTypography = Typography(
    // ── Display (titres héroïques, splash, noms de chapitres) ──
    ...
    // ── Headline (titres de sections, en-têtes) ──
    ...
    // ── Title (titres de cartes, dialogues, toolbars) ──
    ...
    // ── Body (texte courant, contenu de livre) ──
    bodyLarge = TextStyle(
    ...
    // ── Label (boutons, chips, badges, légendes) ──
