package com.readflow.ui.screen.about
...
fun AboutScreen() {
    Column(
        ...
        Text("ReadFlow", color = Color.White, fontWeight = FontWeight.Bold, fontSize = 26.sp)
        ...
        Card(colors = CardDefaults.cardColors(containerColor = CardBg), shape = RoundedCornerShape(14.dp), modifier = Modifier.fillMaxWidth()) {
            Text(
                "ReadFlow est une solution de lecture intelligente conçue pour transformer " +
        ...
        Card(colors = CardDefaults.cardColors(containerColor = CardBg), shape = RoundedCornerShape(14.dp), modifier = Modifier.fillMaxWidth()) {
            Column(modifier = Modifier.padding(20.dp)) {
                Text("Développé avec un objectif d'optimisation matérielle et de performance, ReadFlow s'appuie sur des moteurs open-source industriels de premier plan :", color = Color.White.copy(alpha = 0.55f), fontSize = 13.sp, lineHeight = 19.sp)
                Spacer(Modifier.height(12.dp))
        ...
        CreditCard("Code Source", "github.com/issa14/ReadFlow", Icons.Default.Code)
        CreditCard("Contact", "issadotnet@gmail.com", Icons.Default.Mail)

        Spacer(Modifier.height(16.dp))
        Text("© 2026 ReadFlow. Tous droits réservés.", color = Color.White.copy(alpha = 0.25f), fontSize = 11.sp, textAlign = TextAlign.Center)
